...
class _CommentsScreenState extends State<CommentsScreen> with SingleTickerProviderStateMixin {
  ...
  final List<ReviewModel> _reviews = [
    ...
    ReviewModel(
      ...
      userId: 'u4',
      userName: 'Phạm Thị D',
      avatarUrl: 'https://ui-avatars.com/api/?name=Pham+Thi+D&background=random&size=150',
      productId: 'p4',
    ...
    ReviewModel(
      ...
      avatarUrl: 'https://ui-avatars.com/api/?name=Hoang+Van+E&background=random&size=150',
      productId: 'p5',
