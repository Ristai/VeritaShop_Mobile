...
## Purpose
Tạo document files từ MongoDB data để upload lên OpenAI File Search (Vector Store), hỗ trợ chatbot e-commerce truy vấn ngữ nghĩa về sản phẩm, sentiment reviews theo aspect, và thông tin khuyến mãi.
